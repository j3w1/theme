...
Version 3.0.0; profile default; source digest sha256-p4wLgj+UKGiq36uZ9QEj8UbEVirpOPkMWjtHo108AiM=. Pin the supplying commit and verify manifest source/file digests; the version alone does not identify a revision.
