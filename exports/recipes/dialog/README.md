...
Version 1.2.0; profile default; source digest sha256-+7m4pGDbEqUfFzA0213HEe7nox9MYwvmjEaXDduJcYg=. Pin the supplying commit and verify manifest source/file digests; the version alone does not identify a revision.
