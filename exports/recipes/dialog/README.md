...
Version 1.3.0; profile default; source digest sha256-EZhRLXZsBZDs32VXZNqQJhkRxjIW9axiCDuCEno3Mcs=. Pin the supplying commit and verify manifest source/file digests; the version alone does not identify a revision.
