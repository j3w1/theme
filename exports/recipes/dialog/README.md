...
Version 1.3.0; profile default; source digest sha256-4qYbg/IDFCMfguwQSsUwsXV/RzaD+K0sOTSjQMlXKEc=. Pin the supplying commit and verify manifest source/file digests; the version alone does not identify a revision.
