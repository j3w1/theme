...
Version 3.0.0; profile default; source digest sha256-MR9b+NOkaxO2yWJJH4/hJyFGAvikkw8Mj3A+Ik+rptI=. Pin the supplying commit and verify manifest source/file digests; the version alone does not identify a revision.
