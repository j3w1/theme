...
Version 1.0.0; profile default; source digest sha256-SCnB6UocsHv8hRuzpoIRszdVKAPbl/7LqNfMkHoB7ow=. Pin the supplying commit and verify manifest source/file digests; the version alone does not identify a revision.
