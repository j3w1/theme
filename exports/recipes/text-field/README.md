...
Version 1.3.0; profile default; source digest sha256-adsH5d+ap/P1Sc6i/z28dLKlDoobixnGmMxdYpmSrMk=. Pin the supplying commit and verify manifest source/file digests; the version alone does not identify a revision.
