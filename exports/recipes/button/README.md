...
Version 3.0.0; profile default; source digest sha256-46RL+giIQUlD3fQvxemR1T4YGys3/8GmJl9iCGyBynY=. Pin the supplying commit and verify manifest source/file digests; the version alone does not identify a revision.
