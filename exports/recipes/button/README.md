...
Version 3.0.0; profile default; source digest sha256-mInnM6S9uBMMZzOfEPTV/yUZPMM+g5EUbF/HhABtGNs=. Pin the supplying commit and verify manifest source/file digests; the version alone does not identify a revision.
