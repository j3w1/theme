...
The native push button in the four action tones; primary is the only filled button at rest, destructive fills on hover and always needs a confirmation or an undo. Status: specified, demonstrated, test implemented. Site: https://j3w1.github.io/theme/#c-button. JSON: `exports/components/button.json`.
...
The native checkbox drawn as a 16px square that fills with the primary action colour and a ✓ or – glyph; single, or a fieldset group of independent choices. Status: specified, demonstrated, test implemented. Site: https://j3w1.github.io/theme/#c-checkbox. JSON: `exports/components/checkbox.json`.
...
A native dialog on the overlay surface behind a 1px overlay border and the backdrop; modal when shown, with trapped focus and Escape to close. Status: specified, demonstrated, test implemented. Site: https://j3w1.github.io/theme/#c-dialog. JSON: `exports/components/dialog.json`.
...
The native anchor for navigation; always underlined in the link-underline role, hover fills with the strong hover surface, the current page carries a 2px indicator bar. Status: specified, demonstrated, test implemented. Site: https://j3w1.github.io/theme/#c-link. JSON: `exports/components/link.json`.
...
A menu button that opens a list of actions on the raised surface inside a 1px overlay border; the active item is the selection fill and check items show a glyph. Status: specified, demonstrated, test implemented. Site: https://j3w1.github.io/theme/#c-menu. JSON: `exports/components/menu.json`.
...
A fieldset of native radios for one exclusive choice; each radio is a 16px square that fills with the primary action colour and an inner square when checked. Status: specified, demonstrated, test implemented. Site: https://j3w1.github.io/theme/#c-radio-group. JSON: `exports/components/radio-group.json`.
...
The native single or multiple select in the text-field box with a line-icon chevron; the popup list is host-rendered and outside the theme. Status: specified, demonstrated, test implemented. Site: https://j3w1.github.io/theme/#c-select. JSON: `exports/components/select.json`.
...
A native data table with a header rule, row dividers, hover and selection fills, sortable headers with a glyph, and static empty and loading rows. Status: specified, demonstrated, test implemented. Site: https://j3w1.github.io/theme/#c-table. JSON: `exports/components/table.json`.
...
A tablist of buttons that switches between panels in place; the selected tab carries a 2px indicator bar and bright text, never a fill. Status: specified, demonstrated, test implemented. Site: https://j3w1.github.io/theme/#c-tabs. JSON: `exports/components/tabs.json`.
...
Single-line free-text entry, covering every native input type that renders as a line box; search, number and password are variants, not separate components. Status: specified, demonstrated, test implemented. Site: https://j3w1.github.io/theme/#c-text-field. JSON: `exports/components/text-field.json`.
