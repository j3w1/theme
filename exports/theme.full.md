...
<!-- generated by scripts/generate.mjs from tokens/ and spec/ — do not edit. theme: j3w1-theme 0.1.0-draft.1 · profile: default · sourceDigest: sha256-7AfSaRLzDxySOSUMyoNXLzBLPUgaN3r+wiKRV9uYZJc= -->
...
| Role | Value | Alias of | Use |
| --- | --- | --- | --- |
| `color.surface.sunken` | `#0a0707` | `{color.primitive.ink.15}` | Reading and detail panes set below the canvas. (pending D-008) |
| `color.surface.backdrop` | `rgb(0 0 0 / 65%)` | `{color.primitive.alpha.black-65}` | Behind modal dialogs. (pending D-008) |
| `color.border.divider` | `#2b0e0d` | `{color.primitive.ink.60}` | Hairline between rows and sections. (pending D-008) |
| `color.border.control` | `#a3676b` | `{color.primitive.rose.350}` | Form-control boundary (4.45:1, meets the 3:1 non-text minimum). (pending D-007) |
| `color.border.overlay` | `#e53935` | `{color.primitive.red.800}` | Every floating layer's 1px border. (pending D-008) |
...
| `color.border.control` | `#a3676b` | `{color.primitive.rose.350}` | Form-control boundary (4.45:1, meets the 3:1 non-text minimum). (pending D-007) |
| `color.border.overlay` | `#e53935` | `{color.primitive.red.800}` | Every floating layer's 1px border. (pending D-008) |
| `color.code.syntax.string` | `#86a46f` | `{color.primitive.green.500}` | Strings in green. (pending D-001) |
| `color.code.syntax.number` | `#c9973f` | `{color.primitive.amber.500}` | Numbers in amber. (pending D-001) |
| `color.code.syntax.constant` | `#c9973f` | `{color.primitive.amber.500}` | Constants in amber. (pending D-001) |
| `color.code.syntax.type` | `#7e9ebb` | `{color.primitive.blue.500}` | Types in blue. (pending D-001) |
| `color.terminal.ansi.0` | `#0c0909` | `{color.primitive.ink.20}` | Semantic ANSI slot 0. (pending D-001) |
| `color.terminal.ansi.1` | `#e53935` | `{color.primitive.red.800}` | Semantic ANSI slot 1. (pending D-001) |
| `color.terminal.ansi.2` | `#86a46f` | `{color.primitive.green.500}` | Semantic ANSI slot 2. (pending D-001) |
| `color.terminal.ansi.3` | `#c9973f` | `{color.primitive.amber.500}` | Semantic ANSI slot 3. (pending D-001) |
| `color.terminal.ansi.4` | `#7e9ebb` | `{color.primitive.blue.500}` | Semantic ANSI slot 4. (pending D-001) |
| `color.terminal.ansi.5` | `#b37175` | `{color.primitive.rose.550}` | Semantic ANSI slot 5. (pending D-001) |
| `color.terminal.ansi.6` | `#bd787d` | `{color.primitive.rose.600}` | Semantic ANSI slot 6. (pending D-001) |
| `color.terminal.ansi.7` | `#e99499` | `{color.primitive.rose.700}` | Semantic ANSI slot 7. (pending D-001) |
| `color.terminal.ansi.8` | `#ad7175` | `{color.primitive.rose.450}` | Semantic ANSI slot 8. (pending D-001) |
| `color.terminal.ansi.9` | `#f73f35` | `{color.primitive.red.850}` | Semantic ANSI slot 9. (pending D-001) |
| `color.terminal.ansi.10` | `#7fbf7a` | `{color.primitive.green.600}` | Semantic ANSI slot 10. (pending D-001) |
| `color.terminal.ansi.11` | `#d6a24b` | `{color.primitive.amber.600}` | Semantic ANSI slot 11. (pending D-001) |
| `color.terminal.ansi.12` | `#9ab3c9` | `{color.primitive.blue.600}` | Semantic ANSI slot 12. (pending D-001) |
| `color.terminal.ansi.13` | `#d4868b` | `{color.primitive.rose.650}` | Semantic ANSI slot 13. (pending D-001) |
| `color.terminal.ansi.14` | `#ffa2a7` | `{color.primitive.rose.800}` | Semantic ANSI slot 14. (pending D-001) |
| `color.terminal.ansi.15` | `#f4eeee` | `{color.primitive.paper.90}` | Semantic ANSI slot 15. (pending D-001) |
| `color.chart.series-2` | `#86a46f` | `{color.primitive.green.500}` | Second series in green. (pending D-001) |
| `color.chart.series-3` | `#c9973f` | `{color.primitive.amber.500}` | Third series in amber. (pending D-001) |
| `color.chart.series-4` | `#7e9ebb` | `{color.primitive.blue.500}` | Fourth series in blue. (pending D-001) |
...
| Part | Role | Value |
| --- | --- | --- |
| root.bg | `color.action.primary.bg` | `#871f19` |
| root.text | `color.action.primary.text` | `#f4eeee` |
| root.border | `color.action.primary.border` | `#9e231f` |
| root.bg-hover | `color.action.primary.hover-bg` | `#911410` |
| root.bg-active | `color.action.primary.pressed-bg` | `#630f0d` |
| root.ring | `color.interaction.focus.ring-container` | `#ffa2a7` |
| secondary.bg | `color.action.secondary.bg` | `rgb(0 0 0 / 0%)` |
| secondary.text | `color.action.secondary.text` | `#ffa2a7` |
| secondary.border | `color.action.secondary.border` | `#a3676b` |
| secondary.bg-hover | `color.action.secondary.hover-bg` | `#630f0d` |
| secondary.bg-active | `color.action.secondary.pressed-bg` | `#420f0c` |
| secondary.ring | `color.interaction.focus.ring` | `#e53935` |
| tertiary.text | `color.action.tertiary.text` | `#e99499` |
| tertiary.bg-hover | `color.action.tertiary.hover-bg` | `#1c0a09` |
| tertiary.bg-active | `color.interaction.pressed.bg` | `#420f0c` |
| destructive.text | `color.action.destructive.text` | `#f73f35` |
| destructive.border | `color.action.destructive.border` | `#e53935` |
| destructive.bg-hover | `color.action.destructive.hover-bg` | `#dc282e` |
| destructive.text-hover | `color.action.destructive.hover-text` | `#f9faf9` |
| destructive.bg-active | `color.action.destructive.pressed-bg` | `#ae1914` |
| destructive.bg-filled | `color.action.destructive.filled-bg` | `#dc282e` |
| destructive.text-filled | `color.action.destructive.filled-text` | `#f9faf9` |
| root.border-active | `color.border.active` | `#e53935` |
| root.text-disabled | `color.text.disabled` | `#8a5559` |
| root.bg-disabled | `color.interaction.disabled.bg` | `#160b0b` |
| root.border-disabled | `color.border.disabled` | `#7d1310` |
| loading.glyph | `color.action.primary.text` | `#f4eeee` |
...
| Part | Role | Value |
| --- | --- | --- |
| root.bg | `color.action.secondary.bg` | `rgb(0 0 0 / 0%)` |
| root.text | `color.action.tertiary.text` | `#e99499` |
| root.bg-hover | `color.action.tertiary.hover-bg` | `#1c0a09` |
| root.bg-active | `color.interaction.pressed.bg` | `#420f0c` |
| root.border-active | `color.border.active` | `#e53935` |
| root.ring | `color.interaction.focus.ring` | `#e53935` |
| root.bg-toggled | `color.interaction.selection.bg` | `#911410` |
| root.text-toggled | `color.interaction.selection.text` | `#f4eeee` |
| root.border-toggled | `color.border.selected-indicator` | `#e53935` |
| root.ring-toggled | `color.interaction.focus.ring-container` | `#ffa2a7` |
| root.text-disabled | `color.text.disabled` | `#8a5559` |
| root.bg-disabled | `color.interaction.disabled.bg` | `#160b0b` |
| root.border-disabled | `color.border.disabled` | `#7d1310` |
| icon.stroke | `color.icon.default` | `#e99499` |
...
| Part | Role | Value |
| --- | --- | --- |
| root.text | `color.text.link` | `#ffa2a7` |
| root.underline | `color.text.link-underline` | `#dc282e` |
| root.text-hover | `color.text.link-hover` | `#f4eeee` |
| root.bg-hover | `color.interaction.hover.bg-strong` | `#630f0d` |
| root.ring | `color.interaction.focus.ring` | `#e53935` |
| root.text-visited | `color.text.default` | `#e99499` |
| root.text-current | `color.text.bright` | `#ffa2a7` |
| root.indicator | `color.border.selected-indicator` | `#e53935` |
| icon.stroke | `color.icon.default` | `#e99499` |
...
| Part | Role | Value |
| --- | --- | --- |
| root.text | `color.text.default` | `#e99499` |
| label.text | `color.text.bright` | `#ffa2a7` |
| label.required-mark | `color.status.danger.text` | `#f73f35` |
| control.bg | `color.surface.input` | `#0c0909` |
| control.border | `color.border.control` | `#a3676b` |
| control.border-invalid | `color.status.danger.border` | `#e53935` |
| control.text-disabled | `color.text.disabled` | `#8a5559` |
| control.bg-disabled | `color.interaction.disabled.bg` | `#160b0b` |
| control.border-disabled | `color.border.disabled` | `#7d1310` |
| help.text | `color.text.muted` | `#bd787d` |
| message.text | `color.status.danger.text` | `#f73f35` |
...
| Part | Role | Value |
| --- | --- | --- |
| root.bg | `color.surface.input` | `#0c0909` |
| root.border | `color.border.control` | `#a3676b` |
| root.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
| root.border-focus | `color.border.active` | `#e53935` |
| root.ring | `color.interaction.focus.ring` | `#e53935` |
| root.ring-invalid | `color.interaction.focus.ring-container` | `#ffa2a7` |
| root.border-invalid | `color.status.danger.border` | `#e53935` |
| root.border-disabled | `color.border.disabled` | `#7d1310` |
| root.bg-disabled | `color.interaction.disabled.bg` | `#160b0b` |
| root.border-readonly | `color.border.divider` | `#2b0e0d` |
| input.text | `color.text.default` | `#e99499` |
| input.text-disabled | `color.text.disabled` | `#8a5559` |
| input.placeholder | `color.text.placeholder` | `#bd787d` |
| input.caret | `color.code.caret` | `#e99499` |
| input.selection-bg | `color.interaction.text-selection.bg` | `#911410` |
| input.selection-text | `color.interaction.text-selection.text` | `#f4eeee` |
| label.text | `color.text.bright` | `#ffa2a7` |
| label.required-mark | `color.status.danger.text` | `#f73f35` |
| help.text | `color.text.muted` | `#bd787d` |
| message.text | `color.status.danger.text` | `#f73f35` |
| affix.text | `color.text.muted` | `#bd787d` |
| affix.border | `color.border.divider` | `#2b0e0d` |
| action.text | `color.action.tertiary.text` | `#e99499` |
| action.bg-hover | `color.action.tertiary.hover-bg` | `#1c0a09` |
| loading.glyph | `color.text.muted` | `#bd787d` |
...
| root.bg-disabled | `color.interaction.disabled.bg` | `#160b0b` |
| root.border-readonly | `color.border.divider` | `#2b0e0d` |
| root.bg-readonly | `color.surface.canvas` | `#0c0909` |
| input.text | `color.text.default` | `#e99499` |
| input.text-disabled | `color.text.disabled` | `#8a5559` |
| input.placeholder | `color.text.placeholder` | `#bd787d` |
| input.caret | `color.code.caret` | `#e99499` |
...
| label.required-mark | `color.status.danger.text` | `#f73f35` |
| help.text | `color.text.muted` | `#bd787d` |
| count.text | `color.text.muted` | `#bd787d` |
| count.text-over | `color.status.danger.text` | `#f73f35` |
| message.text | `color.status.danger.text` | `#f73f35` |
...
| root.border-disabled | `color.border.disabled` | `#7d1310` |
| root.bg-disabled | `color.interaction.disabled.bg` | `#160b0b` |
| control.text | `color.text.default` | `#e99499` |
| control.text-disabled | `color.text.disabled` | `#8a5559` |
| chevron.stroke | `color.icon.default` | `#e99499` |
| option.bg | `color.surface.raised` | `#241010` |
| option.text | `color.text.default` | `#e99499` |
| option.bg-selected | `color.interaction.selection.bg` | `#911410` |
| option.text-selected | `color.interaction.selection.text` | `#f4eeee` |
| group.text | `color.text.muted` | `#bd787d` |
| label.text | `color.text.bright` | `#ffa2a7` |
| label.required-mark | `color.status.danger.text` | `#f73f35` |
| help.text | `color.text.muted` | `#bd787d` |
| message.text | `color.status.danger.text` | `#f73f35` |
...
| Part | Role | Value |
| --- | --- | --- |
| box.bg | `color.surface.input` | `#0c0909` |
| box.border | `color.border.control` | `#a3676b` |
| box.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
| box.ring | `color.interaction.focus.ring` | `#e53935` |
| box.bg-checked | `color.action.primary.bg` | `#871f19` |
| box.bg-checked-hover | `color.action.primary.hover-bg` | `#911410` |
| box.glyph | `color.action.primary.text` | `#f4eeee` |
| box.ring-checked | `color.interaction.focus.ring-container` | `#ffa2a7` |
| box.border-invalid | `color.status.danger.border` | `#e53935` |
| box.bg-disabled | `color.interaction.disabled.bg` | `#160b0b` |
| box.border-disabled | `color.border.disabled` | `#7d1310` |
| box.glyph-disabled | `color.text.disabled` | `#8a5559` |
| text.default | `color.text.default` | `#e99499` |
| text.disabled | `color.text.disabled` | `#8a5559` |
| legend.text | `color.text.bright` | `#ffa2a7` |
| legend.required-mark | `color.status.danger.text` | `#f73f35` |
| message.text | `color.status.danger.text` | `#f73f35` |
...
| box.bg-checked | `color.action.primary.bg` | `#871f19` |
| box.bg-checked-hover | `color.action.primary.hover-bg` | `#911410` |
| box.dot | `color.action.primary.text` | `#f4eeee` |
| box.ring-checked | `color.interaction.focus.ring-container` | `#ffa2a7` |
| box.border-invalid | `color.status.danger.border` | `#e53935` |
| box.bg-disabled | `color.interaction.disabled.bg` | `#160b0b` |
| box.border-disabled | `color.border.disabled` | `#7d1310` |
| box.dot-disabled | `color.text.disabled` | `#8a5559` |
| text.default | `color.text.default` | `#e99499` |
| text.disabled | `color.text.disabled` | `#8a5559` |
| legend.text | `color.text.bright` | `#ffa2a7` |
| legend.required-mark | `color.status.danger.text` | `#f73f35` |
...
| Part | Role | Value |
| --- | --- | --- |
| track.bg | `color.surface.input` | `#0c0909` |
| track.border | `color.border.control` | `#a3676b` |
| track.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
| track.ring | `color.interaction.focus.ring` | `#e53935` |
| track.bg-checked | `color.action.primary.bg` | `#871f19` |
| track.bg-checked-hover | `color.action.primary.hover-bg` | `#911410` |
| track.ring-checked | `color.interaction.focus.ring-container` | `#ffa2a7` |
| track.bg-disabled | `color.interaction.disabled.bg` | `#160b0b` |
| track.border-disabled | `color.border.disabled` | `#7d1310` |
| thumb.bg | `color.text.default` | `#e99499` |
| thumb.bg-checked | `color.action.primary.text` | `#f4eeee` |
| thumb.bg-disabled | `color.text.disabled` | `#8a5559` |
| name.text | `color.text.default` | `#e99499` |
| state.text | `color.text.muted` | `#bd787d` |
| name.text-disabled | `color.text.disabled` | `#8a5559` |
...
| Part | Role | Value |
| --- | --- | --- |
| root.border | `color.border.divider` | `#2b0e0d` |
| root.bg | `color.surface.default` | `#160b0b` |
| legend.text | `color.text.bright` | `#ffa2a7` |
| body.text | `color.text.default` | `#e99499` |
| legend.text-disabled | `color.text.disabled` | `#8a5559` |
| field.bg | `color.surface.input` | `#0c0909` |
| field.border | `color.border.control` | `#a3676b` |
| field.bg-disabled | `color.interaction.disabled.bg` | `#160b0b` |
| field.border-disabled | `color.border.disabled` | `#7d1310` |
| field.text-disabled | `color.text.disabled` | `#8a5559` |
| help.text | `color.text.muted` | `#bd787d` |
...
| input.text-disabled | `color.text.disabled` | `#8a5559` |
| input.caret | `color.code.caret` | `#e99499` |
| unit.text | `color.text.muted` | `#bd787d` |
| unit.border | `color.border.divider` | `#2b0e0d` |
| action.text | `color.action.tertiary.text` | `#e99499` |
| action.bg-hover | `color.action.tertiary.hover-bg` | `#1c0a09` |
| action.border | `color.border.divider` | `#2b0e0d` |
| label.text | `color.text.bright` | `#ffa2a7` |
| help.text | `color.text.muted` | `#bd787d` |
| message.text | `color.status.danger.text` | `#f73f35` |
...
| icon.stroke | `color.icon.default` | `#e99499` |
| loading.glyph | `color.text.muted` | `#bd787d` |
| clear.text | `color.action.tertiary.text` | `#e99499` |
| clear.bg-hover | `color.action.tertiary.hover-bg` | `#1c0a09` |
| kbd.text | `color.text.muted` | `#bd787d` |
| kbd.border | `color.border.default` | `#531310` |
| label.text | `color.text.bright` | `#ffa2a7` |
| help.text | `color.text.muted` | `#bd787d` |
| status.text | `color.text.muted` | `#bd787d` |
...
| input.placeholder | `color.text.placeholder` | `#bd787d` |
| input.caret | `color.code.caret` | `#e99499` |
| toggle.text | `color.action.tertiary.text` | `#e99499` |
| toggle.bg-hover | `color.action.tertiary.hover-bg` | `#1c0a09` |
| label.text | `color.text.bright` | `#ffa2a7` |
| listbox.bg | `color.surface.raised` | `#241010` |
| listbox.border | `color.border.overlay` | `#e53935` |
| option.text | `color.text.default` | `#e99499` |
| option.bg-hover | `color.interaction.hover.bg-strong` | `#630f0d` |
| option.text-hover | `color.text.link-hover` | `#f4eeee` |
| option.bg-selected | `color.interaction.selection.bg` | `#911410` |
| option.text-selected | `color.interaction.selection.text` | `#f4eeee` |
| option.ring-selected | `color.interaction.focus.ring-container` | `#ffa2a7` |
| group.text | `color.text.subtle` | `#ad7175` |
| group.border | `color.border.divider` | `#2b0e0d` |
| empty.text | `color.text.muted` | `#bd787d` |
| help.text | `color.text.muted` | `#bd787d` |
| message.text | `color.status.danger.text` | `#f73f35` |
...
| label.text | `color.text.bright` | `#ffa2a7` |
| legend.text | `color.text.bright` | `#ffa2a7` |
| separator.text | `color.text.muted` | `#bd787d` |
| help.text | `color.text.muted` | `#bd787d` |
| message.text | `color.status.danger.text` | `#f73f35` |
...
| Part | Role | Value |
| --- | --- | --- |
| button.bg | `color.action.secondary.bg` | `rgb(0 0 0 / 0%)` |
| button.text | `color.action.secondary.text` | `#ffa2a7` |
| button.border | `color.action.secondary.border` | `#a3676b` |
| button.bg-hover | `color.action.secondary.hover-bg` | `#630f0d` |
| button.bg-pressed | `color.action.secondary.pressed-bg` | `#420f0c` |
| button.ring | `color.interaction.focus.ring` | `#e53935` |
| button.border-invalid | `color.status.danger.border` | `#e53935` |
| button.text-disabled | `color.text.disabled` | `#8a5559` |
| button.border-disabled | `color.border.disabled` | `#7d1310` |
| button.bg-disabled | `color.interaction.disabled.bg` | `#160b0b` |
| zone.border | `color.interaction.drop-target` | `#e53935` |
| zone.bg-drop-target | `color.interaction.marquee` | `rgb(145 20 16 / 12%)` |
| zone.hint | `color.text.muted` | `#bd787d` |
| label.text | `color.text.bright` | `#ffa2a7` |
| status.text | `color.text.muted` | `#bd787d` |
| list.text | `color.text.default` | `#e99499` |
| list.divider | `color.border.divider` | `#2b0e0d` |
| list.size | `color.text.subtle` | `#ad7175` |
| list.error | `color.status.danger.text` | `#f73f35` |
| remove.text | `color.action.tertiary.text` | `#e99499` |
| remove.bg-hover | `color.action.tertiary.hover-bg` | `#1c0a09` |
| progress.track | `color.interaction.pressed.bg` | `#420f0c` |
| progress.stripe | `color.action.primary.bg` | `#871f19` |
| help.text | `color.text.muted` | `#bd787d` |
| message.text | `color.status.danger.text` | `#f73f35` |
...
| Part | Role | Value |
| --- | --- | --- |
| steps.divider | `color.border.divider` | `#2b0e0d` |
| step.text | `color.text.default` | `#e99499` |
| step.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
| step.ring | `color.interaction.focus.ring` | `#e53935` |
| step.text-current | `color.text.bright` | `#ffa2a7` |
| step.indicator-current | `color.border.selected-indicator` | `#e53935` |
| step.text-disabled | `color.text.disabled` | `#8a5559` |
| step.marker-complete | `color.status.success.text` | `#86a46f` |
| step.marker-invalid | `color.status.danger.text` | `#f73f35` |
| step.indicator-invalid | `color.status.danger.border` | `#e53935` |
| panel.bg | `color.surface.default` | `#160b0b` |
| panel.border | `color.border.default` | `#531310` |
| title.text | `color.text.bright` | `#ffa2a7` |
| text.text | `color.text.default` | `#e99499` |
| message.text | `color.status.danger.text` | `#f73f35` |
| next.bg | `color.action.primary.bg` | `#871f19` |
| next.text | `color.action.primary.text` | `#f4eeee` |
| next.bg-hover | `color.action.primary.hover-bg` | `#911410` |
| next.bg-pressed | `color.action.primary.pressed-bg` | `#630f0d` |
| next.border | `color.action.primary.border` | `#9e231f` |
| next.ring | `color.interaction.focus.ring-container` | `#ffa2a7` |
| back.text | `color.action.secondary.text` | `#ffa2a7` |
| back.border | `color.action.secondary.border` | `#a3676b` |
| back.bg-hover | `color.action.secondary.hover-bg` | `#630f0d` |
| busy.glyph | `color.action.primary.text` | `#f4eeee` |
...
| Part | Role | Value |
| --- | --- | --- |
| list.bg | `color.surface.default` | `#160b0b` |
| list.border | `color.border.divider` | `#2b0e0d` |
| tab.text | `color.text.default` | `#e99499` |
| tab.text-selected | `color.text.bright` | `#ffa2a7` |
| tab.text-disabled | `color.text.disabled` | `#8a5559` |
| tab.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
| tab.bg-pressed | `color.interaction.pressed.bg` | `#420f0c` |
| tab.indicator | `color.border.selected-indicator` | `#e53935` |
| tab.indicator-inactive | `color.border.selected-indicator-inactive` | `#9e231f` |
| tab.ring | `color.interaction.focus.ring` | `#e53935` |
| panel.bg | `color.surface.default` | `#160b0b` |
| panel.text | `color.text.default` | `#e99499` |
...
| --- | --- | --- |
| root.bg | `color.surface.default` | `#160b0b` |
| link.text | `color.text.link` | `#ffa2a7` |
| link.underline | `color.text.link-underline` | `#dc282e` |
| link.text-hover | `color.text.link-hover` | `#f4eeee` |
| link.bg-hover | `color.interaction.hover.bg-strong` | `#630f0d` |
| link.ring | `color.interaction.focus.ring` | `#e53935` |
| current.text | `color.text.bright` | `#ffa2a7` |
| separator.text | `color.text.muted` | `#bd787d` |
| ellipsis.text | `color.text.default` | `#e99499` |
| ellipsis.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
...
| --- | --- | --- |
| root.bg | `color.surface.default` | `#160b0b` |
| link.text | `color.text.default` | `#e99499` |
| link.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
| link.bg-pressed | `color.interaction.pressed.bg` | `#420f0c` |
| link.ring | `color.interaction.focus.ring` | `#e53935` |
| link.text-disabled | `color.text.disabled` | `#8a5559` |
| current.bg | `color.interaction.selection.bg` | `#911410` |
| current.text | `color.text.on-selection` | `#f4eeee` |
| current.ring | `color.interaction.focus.ring-container` | `#ffa2a7` |
| gap.text | `color.text.muted` | `#bd787d` |
| status.text | `color.text.default` | `#e99499` |
| status.emphasis | `color.text.bright` | `#ffa2a7` |
...
| link.bg-pressed | `color.interaction.pressed.bg` | `#420f0c` |
| link.ring | `color.interaction.focus.ring` | `#e53935` |
| link.indicator | `color.border.selected-indicator` | `#e53935` |
| link.indicator-inactive | `color.border.selected-indicator-inactive` | `#9e231f` |
| current.text | `color.text.bright` | `#ffa2a7` |
| selected.bg | `color.interaction.selection.bg` | `#911410` |
| selected.text | `color.interaction.selection.text` | `#f4eeee` |
| selected.ring | `color.interaction.focus.ring-container` | `#ffa2a7` |
| selected.inactive-bg | `color.interaction.selection.inactive-bg` | `#420f0c` |
| selected.inactive-text | `color.interaction.selection.inactive-text` | `#e99499` |
| icon.stroke | `color.icon.default` | `#e99499` |
| group.chevron | `color.icon.decorative` | `#a3676b` |
...
| Part | Role | Value |
| --- | --- | --- |
| root.bg | `color.surface.chrome` | `#100909` |
| root.border | `color.border.divider` | `#2b0e0d` |
| button.text | `color.text.default` | `#e99499` |
| button.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
| button.bg-pressed | `color.interaction.pressed.bg` | `#420f0c` |
| button.ring | `color.interaction.focus.ring` | `#e53935` |
| button.text-disabled | `color.text.disabled` | `#8a5559` |
| toggled.bg | `color.interaction.pressed.bg` | `#420f0c` |
| toggled.border | `color.border.active` | `#e53935` |
| toggled.text | `color.text.bright` | `#ffa2a7` |
| separator.color | `color.border.default` | `#531310` |
| more.chevron | `color.icon.decorative` | `#a3676b` |
...
| --- | --- | --- |
| button.text | `color.text.default` | `#e99499` |
| button.bg | `color.surface.default` | `#160b0b` |
| button.border | `color.border.control` | `#a3676b` |
| button.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
| button.bg-open | `color.interaction.pressed.bg` | `#420f0c` |
| button.border-open | `color.border.active` | `#e53935` |
| button.ring | `color.interaction.focus.ring` | `#e53935` |
| surface.bg | `color.surface.raised` | `#241010` |
| surface.border | `color.border.overlay` | `#e53935` |
| item.text | `color.text.default` | `#e99499` |
| item.bg-hover | `color.interaction.hover.bg-strong` | `#630f0d` |
| item.text-hover | `color.text.link-hover` | `#f4eeee` |
| item.text-disabled | `color.text.disabled` | `#8a5559` |
| active.bg | `color.interaction.selection.bg` | `#911410` |
| active.text | `color.interaction.selection.text` | `#f4eeee` |
| active.ring | `color.interaction.focus.ring-container` | `#ffa2a7` |
| check.glyph | `color.text.bright` | `#ffa2a7` |
| shortcut.text | `color.text.muted` | `#bd787d` |
| separator.color | `color.border.divider` | `#2b0e0d` |
| chevron.color | `color.icon.decorative` | `#a3676b` |
...
| Part | Role | Value |
| --- | --- | --- |
| root.bg | `color.surface.raised` | `#241010` |
| root.text | `color.text.bright` | `#ffa2a7` |
| root.border | `color.border.overlay` | `#e53935` |
| root.ring | `color.interaction.focus.ring` | `#e53935` |
...
| --- | --- | --- |
| root.bg | `color.surface.default` | `#160b0b` |
| root.border | `color.border.default` | `#531310` |
| root.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
| root.border-hover | `color.border.control` | `#a3676b` |
| root.ring | `color.interaction.focus.ring-container` | `#ffa2a7` |
| title.text | `color.text.bright` | `#ffa2a7` |
| body.text | `color.text.default` | `#e99499` |
| meta.text | `color.text.muted` | `#bd787d` |
| selected.bg | `color.interaction.selection.bg` | `#911410` |
| selected.text | `color.interaction.selection.text` | `#f4eeee` |
| selected.ring | `color.interaction.focus.ring-container` | `#ffa2a7` |
...
| root.bg | `color.surface.default` | `#160b0b` |
| root.border | `color.border.control` | `#a3676b` |
| row.text | `color.text.default` | `#e99499` |
| row.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
| row.divider | `color.border.divider` | `#2b0e0d` |
| row.ring | `color.interaction.focus.ring` | `#e53935` |
| row.text-disabled | `color.text.disabled` | `#8a5559` |
| selected.bg | `color.interaction.selection.bg` | `#911410` |
| selected.text | `color.interaction.selection.text` | `#f4eeee` |
| selected.ring | `color.interaction.focus.ring-container` | `#ffa2a7` |
| selected.inactive-bg | `color.interaction.selection.inactive-bg` | `#420f0c` |
| selected.inactive-text | `color.interaction.selection.inactive-text` | `#e99499` |
| check.glyph | `color.interaction.selection.text` | `#f4eeee` |
| meta.text | `color.text.muted` | `#bd787d` |
...
| Part | Role | Value |
| --- | --- | --- |
| danger.bg | `color.status.danger.fill` | `#dc282e` |
| danger.text | `color.status.danger.on-fill` | `#f9faf9` |
| danger.border | `color.status.danger.border` | `#e53935` |
| danger.outline-text | `color.status.danger.text` | `#f73f35` |
| warning.bg | `color.status.warning.fill` | `#c9973f` |
| warning.text | `color.status.warning.on-fill` | `#0c0909` |
| warning.border | `color.status.warning.border` | `#c9973f` |
| warning.outline-text | `color.status.warning.text` | `#c9973f` |
| success.bg | `color.status.success.fill` | `#86a46f` |
| success.text | `color.status.success.on-fill` | `#0c0909` |
| success.border | `color.status.success.border` | `#86a46f` |
| success.outline-text | `color.status.success.text` | `#86a46f` |
| info.bg | `color.status.info.fill` | `#7e9ebb` |
| info.text | `color.status.info.on-fill` | `#0c0909` |
| info.border | `color.status.info.border` | `#7e9ebb` |
| info.outline-text | `color.status.info.text` | `#7e9ebb` |
| neutral.bg | `color.status.neutral.fill` | `#a3676b` |
| neutral.text | `color.status.neutral.on-fill` | `#000000` |
| neutral.border | `color.status.neutral.border` | `#a3676b` |
| neutral.outline-text | `color.status.neutral.text` | `#bd787d` |
| count.bg | `color.action.primary.bg` | `#871f19` |
| count.text | `color.action.primary.text` | `#f4eeee` |
...
| root.text | `color.text.default` | `#e99499` |
| root.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
| root.bg-pressed | `color.interaction.pressed.bg` | `#420f0c` |
| root.ring | `color.interaction.focus.ring` | `#e53935` |
| root.text-disabled | `color.text.disabled` | `#8a5559` |
| root.border-disabled | `color.border.disabled` | `#7d1310` |
| root.bg-disabled | `color.interaction.disabled.bg` | `#160b0b` |
...
| selected.text | `color.interaction.selection.text` | `#f4eeee` |
| selected.ring | `color.interaction.focus.ring-container` | `#ffa2a7` |
| remove.text | `color.text.muted` | `#bd787d` |
| remove.text-hover | `color.text.bright` | `#ffa2a7` |
| remove.bg-hover | `color.interaction.hover.bg-strong` | `#630f0d` |
...
| --- | --- | --- |
| root.bg | `color.surface.default` | `#160b0b` |
| header.text | `color.text.bright` | `#ffa2a7` |
| header.bg | `color.surface.default` | `#160b0b` |
| header.rule | `color.border.strong` | `#9e231f` |
| header.bg-sticky | `color.surface.raised` | `#241010` |
| sort.glyph | `color.text.bright` | `#ffa2a7` |
| sort.ring | `color.interaction.focus.ring` | `#e53935` |
| row.text | `color.text.default` | `#e99499` |
| row.divider | `color.border.divider` | `#2b0e0d` |
| row.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
| selected.bg | `color.interaction.selection.bg` | `#911410` |
...
| selected.inactive-bg | `color.interaction.selection.inactive-bg` | `#420f0c` |
| selected.inactive-text | `color.interaction.selection.inactive-text` | `#e99499` |
| caption.text | `color.text.muted` | `#bd787d` |
| empty.text | `color.text.muted` | `#bd787d` |
| loading.glyph | `color.text.muted` | `#bd787d` |
...
| selected.text | `color.interaction.selection.text` | `#f4eeee` |
| selected.ring | `color.interaction.focus.ring-container` | `#ffa2a7` |
| checkbox.bg | `color.surface.input` | `#0c0909` |
| checkbox.border | `color.border.control` | `#a3676b` |
| checkbox.checked-bg | `color.action.primary.bg` | `#871f19` |
| checkbox.glyph | `color.action.primary.text` | `#f4eeee` |
| resize.handle | `color.border.default` | `#531310` |
| resize.handle-hover | `color.border.active` | `#e53935` |
| empty.text | `color.text.muted` | `#bd787d` |
| loading.glyph | `color.text.muted` | `#bd787d` |
...
| Part | Role | Value |
| --- | --- | --- |
| danger.bg | `color.status.danger.tint` | `#2b0e0d` |
| danger.border | `color.status.danger.border` | `#e53935` |
| danger.text | `color.status.danger.text` | `#f73f35` |
| warning.bg | `color.status.warning.tint` | `#1f1a0c` |
| warning.border | `color.status.warning.border` | `#c9973f` |
| warning.text | `color.status.warning.text` | `#c9973f` |
| success.bg | `color.status.success.tint` | `#0f1a0e` |
| success.border | `color.status.success.border` | `#86a46f` |
| success.text | `color.status.success.text` | `#86a46f` |
| info.bg | `color.status.info.tint` | `#0f141c` |
| info.border | `color.status.info.border` | `#7e9ebb` |
| info.text | `color.status.info.text` | `#7e9ebb` |
| neutral.bg | `color.status.neutral.tint` | `#241010` |
| neutral.border | `color.status.neutral.border` | `#a3676b` |
| neutral.text | `color.status.neutral.text` | `#bd787d` |
| body.text | `color.text.default` | `#e99499` |
| close.text | `color.action.tertiary.text` | `#e99499` |
| close.bg-hover | `color.action.tertiary.hover-bg` | `#1c0a09` |
| close.ring | `color.interaction.focus.ring` | `#e53935` |
...
| Part | Role | Value |
| --- | --- | --- |
| root.bg | `color.surface.canvas` | `#0c0909` |
| root.border | `color.border.overlay` | `#e53935` |
| root.text | `color.text.default` | `#e99499` |
| glyph.text | `color.status.info.text` | `#7e9ebb` |
| warning.bg | `color.status.warning.tint` | `#1f1a0c` |
| warning.border | `color.status.warning.border` | `#c9973f` |
| warning.text | `color.status.warning.text` | `#c9973f` |
| success.bg | `color.status.success.tint` | `#0f1a0e` |
...
| danger.bg | `color.status.danger.fill` | `#dc282e` |
| danger.text | `color.status.danger.on-fill` | `#f9faf9` |
| danger.button-bg-hover | `color.action.destructive.pressed-bg` | `#ae1914` |
| action.text | `color.text.link` | `#ffa2a7` |
| action.bg-hover | `color.interaction.hover.bg-strong` | `#630f0d` |
| action.text-hover | `color.text.link-hover` | `#f4eeee` |
| close.text | `color.action.tertiary.text` | `#e99499` |
| close.bg-hover | `color.action.tertiary.hover-bg` | `#1c0a09` |
| close.ring | `color.interaction.focus.ring` | `#e53935` |
| count.text | `color.text.muted` | `#bd787d` |
...
| Part | Role | Value |
| --- | --- | --- |
| track.bg | `color.interaction.pressed.bg` | `#420f0c` |
| track.border | `color.border.control` | `#a3676b` |
| value.bg | `color.action.primary.bg` | `#871f19` |
| value.bg-error | `color.status.danger.fill` | `#dc282e` |
| stripe.a | `color.action.primary.bg` | `#871f19` |
| stripe.b | `color.interaction.pressed.bg` | `#420f0c` |
| label.text | `color.text.bright` | `#ffa2a7` |
| value.text | `color.text.default` | `#e99499` |
| detail.text | `color.text.muted` | `#bd787d` |
| error.text | `color.status.danger.text` | `#f73f35` |
...
| Part | Role | Value |
| --- | --- | --- |
| glyph.text | `color.text.muted` | `#bd787d` |
| label.text | `color.text.default` | `#e99499` |
| block.bg | `color.surface.default` | `#160b0b` |
| block.border | `color.border.divider` | `#2b0e0d` |
...
| Part | Role | Value |
| --- | --- | --- |
| popup.bg | `color.surface.raised` | `#241010` |
| popup.border | `color.border.overlay` | `#e53935` |
| popup.text | `color.text.default` | `#e99499` |
| shortcut.text | `color.text.bright` | `#ffa2a7` |
| shortcut.border | `color.border.control` | `#a3676b` |
| trigger.text | `color.action.tertiary.text` | `#e99499` |
| trigger.bg-hover | `color.action.tertiary.hover-bg` | `#1c0a09` |
| trigger.ring | `color.interaction.focus.ring` | `#e53935` |
| popup.z | `z.popover` | `10` |
...
| Part | Role | Value |
| --- | --- | --- |
| backdrop.bg | `color.surface.backdrop` | `rgb(0 0 0 / 65%)` |
| root.bg | `color.surface.overlay` | `#241010` |
| root.border | `color.border.overlay` | `#e53935` |
| root.ring | `color.interaction.focus.ring-container` | `#ffa2a7` |
| root.z | `z.dialog` | `30` |
| title.text | `color.text.bright` | `#ffa2a7` |
...
| button.border | `color.action.secondary.border` | `#a3676b` |
| button.bg-hover | `color.action.secondary.hover-bg` | `#630f0d` |
| primary.bg | `color.action.primary.bg` | `#871f19` |
| primary.text | `color.action.primary.text` | `#f4eeee` |
| primary.bg-hover | `color.action.primary.hover-bg` | `#911410` |
| destructive.bg | `color.action.destructive.filled-bg` | `#dc282e` |
| destructive.text | `color.action.destructive.filled-text` | `#f9faf9` |
| destructive.bg-hover | `color.action.destructive.hover-bg` | `#dc282e` |
| field.bg | `color.surface.input` | `#0c0909` |
| field.border | `color.border.control` | `#a3676b` |
| field.label | `color.text.bright` | `#ffa2a7` |
| note.text | `color.text.muted` | `#bd787d` |
...
| title.text | `color.text.bright` | `#ffa2a7` |
| text.text | `color.text.default` | `#e99499` |
| body.divider | `color.border.divider` | `#2b0e0d` |
| item.text | `color.text.default` | `#e99499` |
| item.bg-hover | `color.interaction.hover.bg-strong` | `#630f0d` |
| item.text-hover | `color.text.link-hover` | `#f4eeee` |
| close.text | `color.action.tertiary.text` | `#e99499` |
...
| root.bg | `color.surface.default` | `#160b0b` |
| root.border | `color.border.divider` | `#2b0e0d` |
| glyph.text | `color.icon.decorative` | `#a3676b` |
| heading.text | `color.text.bright` | `#ffa2a7` |
| text.text | `color.text.muted` | `#bd787d` |
| action.text | `color.action.secondary.text` | `#ffa2a7` |
| action.border | `color.action.secondary.border` | `#a3676b` |
| action.bg-hover | `color.action.secondary.hover-bg` | `#630f0d` |
| action.ring | `color.interaction.focus.ring` | `#e53935` |
...
| Part | Role | Value |
| --- | --- | --- |
| root.bg | `color.code.bg` | `#0c0909` |
| root.border | `color.border.control` | `#a3676b` |
| root.ring | `color.interaction.focus.ring-container` | `#ffa2a7` |
| gutter.bg | `color.code.gutter-bg` | `#0c0909` |
| gutter.rule | `color.code.gutter-rule` | `#2b0e0d` |
| gutter.bg-read-only | `color.surface.sunken` | `#0a0707` |
| line-number.text | `color.code.line-number` | `#ad7175` |
| line-number.text-active | `color.code.line-number-active` | `#e99499` |
| line.bg-current | `color.code.current-line` | `#1c0a09` |
| caret.bg | `color.code.caret` | `#e99499` |
| selection.bg | `color.code.selection-bg` | `#420f0c` |
| selection.bg-inactive | `color.interaction.selection.inactive-bg` | `#420f0c` |
| selection.text-inactive | `color.interaction.selection.inactive-text` | `#e99499` |
| bracket.outline | `color.code.bracket-match` | `#e53935` |
| indent.guide | `color.code.indent-guide` | `#531310` |
| whitespace.text | `color.code.whitespace` | `#7d1310` |
| fold.text | `color.text.muted` | `#bd787d` |
| fold.border | `color.border.control` | `#a3676b` |
| syntax.keyword | `color.code.syntax.keyword` | `#f73f35` |
| syntax.string | `color.code.syntax.string` | `#bd787d` |
| syntax.comment | `color.code.syntax.comment` | `#ad7175` |
| syntax.number | `color.code.syntax.number` | `#d4868b` |
| syntax.constant | `color.code.syntax.constant` | `#d4868b` |
| syntax.function | `color.code.syntax.function` | `#ffa2a7` |
| syntax.variable | `color.code.syntax.variable` | `#e99499` |
| syntax.type | `color.code.syntax.type` | `#b37175` |
| syntax.operator | `color.code.syntax.operator` | `#e99499` |
| syntax.punctuation | `color.code.syntax.punctuation` | `#e99499` |
| syntax.property | `color.code.syntax.property` | `#e53935` |
| syntax.heading | `color.code.syntax.heading` | `#e53935` |
| syntax.tag | `color.code.syntax.tag` | `#f73f35` |
| syntax.attribute | `color.code.syntax.attribute` | `#d4868b` |
| syntax.escape | `color.code.syntax.escape` | `#d4868b` |
| syntax.invalid | `color.code.syntax.invalid` | `#e53935` |
| syntax.deprecated | `color.code.syntax.deprecated` | `#ad7175` |
...
| root.bg | `color.surface.default` | `#160b0b` |
| root.border | `color.border.control` | `#a3676b` |
| code.bg | `color.code.bg` | `#0c0909` |
| code.text | `color.text.default` | `#e99499` |
| code.line-number | `color.code.line-number` | `#ad7175` |
| code.gutter-rule | `color.code.gutter-rule` | `#2b0e0d` |
| code.selection-bg | `color.code.selection-bg` | `#420f0c` |
| error.underline | `color.diagnostic.error.underline` | `#e53935` |
| error.text | `color.diagnostic.error.text` | `#f73f35` |
| error.stripe | `color.diagnostic.error.stripe` | `#e53935` |
| error.line-bg | `color.diagnostic.error.bg` | `#2b0e0d` |
| warning.underline | `color.diagnostic.warning.underline` | `#c9973f` |
| warning.text | `color.diagnostic.warning.text` | `#c9973f` |
| warning.stripe | `color.diagnostic.warning.stripe` | `#c9973f` |
| info.underline | `color.diagnostic.info.underline` | `#7e9ebb` |
| info.text | `color.diagnostic.info.text` | `#7e9ebb` |
| hint.underline | `color.diagnostic.hint.underline` | `#ad7175` |
| hint.text | `color.text.subtle` | `#ad7175` |
| unused.text | `color.diagnostic.unused.text` | `#bd787d` |
| deprecated.text | `color.code.syntax.deprecated` | `#ad7175` |
| row.text | `color.text.default` | `#e99499` |
| row.location | `color.text.muted` | `#bd787d` |
| row.divider | `color.border.divider` | `#2b0e0d` |
| row.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
| row.ring | `color.interaction.focus.ring` | `#e53935` |
| row.bg-selected | `color.interaction.selection.bg` | `#911410` |
| row.text-selected | `color.interaction.selection.text` | `#f4eeee` |
| row.ring-selected | `color.interaction.focus.ring-container` | `#ffa2a7` |
| header.text | `color.text.bright` | `#ffa2a7` |
| status.text | `color.status.danger.text` | `#f73f35` |
| empty.text | `color.text.muted` | `#bd787d` |
| empty.glyph | `color.status.success.text` | `#86a46f` |
...
| root.border | `color.border.control` | `#a3676b` |
| root.text | `color.text.default` | `#e99499` |
| line-number.text | `color.text.muted` | `#bd787d` |
| line-number.rule | `color.code.gutter-rule` | `#2b0e0d` |
| row.divider | `color.border.divider` | `#2b0e0d` |
| added.bg | `color.diff.added.bg` | `#0f1a0e` |
| added.gutter | `color.diff.added.gutter` | `#86a46f` |
| added.emphasis | `color.diff.added.emphasis` | `#86a46f` |
| removed.bg | `color.diff.removed.bg` | `#2b0e0d` |
| removed.gutter | `color.diff.removed.gutter` | `#e53935` |
| removed.emphasis | `color.diff.removed.emphasis` | `#e53935` |
| modified.bg | `color.diff.modified.bg` | `#1f1a0c` |
| modified.gutter | `color.diff.modified.gutter` | `#c9973f` |
| hunk.bg | `color.diff.header-bg` | `#241010` |
| hunk.text | `color.text.muted` | `#bd787d` |
| hunk.context | `color.text.default` | `#e99499` |
| conflict.border | `color.diff.conflict-border` | `#f73f35` |
| conflict.marker | `color.text.bright` | `#ffa2a7` |
| fold.text | `color.text.link` | `#ffa2a7` |
| fold.bg-hover | `color.interaction.hover.bg-strong` | `#630f0d` |
| row.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
| row.ring | `color.interaction.focus.ring` | `#e53935` |
| row.bg-selected | `color.interaction.selection.bg` | `#911410` |
| row.text-selected | `color.interaction.selection.text` | `#f4eeee` |
...
| Part | Role | Value |
| --- | --- | --- |
| root.bg | `color.terminal.bg` | `#0c0909` |
| root.text | `color.terminal.fg` | `#e99499` |
| root.border | `color.border.control` | `#a3676b` |
| root.ring | `color.interaction.focus.ring-container` | `#ffa2a7` |
| cursor.bg | `color.terminal.cursor` | `#e99499` |
| cursor.text | `color.terminal.bg` | `#0c0909` |
| selection.bg | `color.terminal.selection-bg` | `#911410` |
| selection.text | `color.terminal.selection-text` | `#f4eeee` |
| current.bg | `color.code.current-line` | `#1c0a09` |
| prompt.bg | `color.terminal.ansi.4` | `#8c1212` |
| prompt.text | `color.terminal.selection-text` | `#f4eeee` |
| prompt.branch-bg | `color.terminal.ansi.3` | `#d4868b` |
| prompt.branch-text | `color.terminal.bg` | `#0c0909` |
| dim.text | `color.text.muted` | `#bd787d` |
| inverse.bg | `color.terminal.fg` | `#e99499` |
| inverse.text | `color.terminal.bg` | `#0c0909` |
| label.text | `color.text.muted` | `#bd787d` |
| fail.glyph | `color.terminal.fg` | `#e99499` |
| slot.ansi-0 | `color.terminal.ansi.0` | `#0c0909` |
| slot.ansi-1 | `color.terminal.ansi.1` | `#c81a1a` |
| slot.ansi-2 | `color.terminal.ansi.2` | `#bd787d` |
| slot.ansi-3 | `color.terminal.ansi.3` | `#d4868b` |
| slot.ansi-4 | `color.terminal.ansi.4` | `#8c1212` |
| slot.ansi-5 | `color.terminal.ansi.5` | `#f73f35` |
| slot.ansi-6 | `color.terminal.ansi.6` | `#9e474a` |
| slot.ansi-7 | `color.terminal.ansi.7` | `#ffa2a7` |
| slot.ansi-8 | `color.terminal.ansi.8` | `#7d1310` |
| slot.ansi-9 | `color.terminal.ansi.9` | `#ab1612` |
| slot.ansi-10 | `color.terminal.ansi.10` | `#ad2721` |
| slot.ansi-11 | `color.terminal.ansi.11` | `#b37175` |
| slot.ansi-12 | `color.terminal.ansi.12` | `#871f19` |
| slot.ansi-13 | `color.terminal.ansi.13` | `#e82132` |
| slot.ansi-14 | `color.terminal.ansi.14` | `#e0292f` |
| slot.ansi-15 | `color.terminal.ansi.15` | `#a3676b` |
...
| root.bg | `color.surface.default` | `#160b0b` |
| root.border | `color.border.default` | `#531310` |
| nav.bg | `color.surface.default` | `#160b0b` |
| nav.border | `color.border.divider` | `#2b0e0d` |
| nav.text | `color.text.default` | `#e99499` |
| nav.current-text | `color.text.bright` | `#ffa2a7` |
| nav.current-indicator | `color.border.selected-indicator` | `#e53935` |
| nav.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
| title.text | `color.text.bright` | `#ffa2a7` |
| lead.text | `color.text.muted` | `#bd787d` |
| group.border | `color.border.divider` | `#2b0e0d` |
| group.legend | `color.text.bright` | `#ffa2a7` |
| control.bg | `color.surface.input` | `#0c0909` |
| control.border | `color.border.control` | `#a3676b` |
| control.text | `color.text.default` | `#e99499` |
| control.ring | `color.interaction.focus.ring` | `#e53935` |
| control.checked-bg | `color.action.primary.bg` | `#871f19` |
| control.checked-glyph | `color.action.primary.text` | `#f4eeee` |
| invalid.border | `color.status.danger.border` | `#e53935` |
| invalid.message | `color.status.danger.text` | `#f73f35` |
| footer.border | `color.border.divider` | `#2b0e0d` |
| apply.bg | `color.action.primary.bg` | `#871f19` |
| apply.text | `color.action.primary.text` | `#f4eeee` |
| apply.busy-glyph | `color.action.primary.text` | `#f4eeee` |
| reset.text | `color.action.secondary.text` | `#ffa2a7` |
| reset.border | `color.action.secondary.border` | `#a3676b` |
...
| root.bg | `color.surface.default` | `#160b0b` |
| root.border | `color.border.default` | `#531310` |
| crumbs.link | `color.text.link` | `#ffa2a7` |
| crumbs.current | `color.text.bright` | `#ffa2a7` |
| title.text | `color.text.bright` | `#ffa2a7` |
| step.text | `color.text.default` | `#e99499` |
| step.current-text | `color.text.bright` | `#ffa2a7` |
| step.current-indicator | `color.border.selected-indicator` | `#e53935` |
| step.complete | `color.status.success.text` | `#86a46f` |
| step.invalid | `color.status.danger.text` | `#f73f35` |
| notice.tint | `color.status.info.tint` | `#0f141c` |
| notice.border | `color.status.info.border` | `#7e9ebb` |
| notice.text | `color.status.info.text` | `#7e9ebb` |
| summary.tint | `color.status.danger.tint` | `#2b0e0d` |
| summary.border | `color.status.danger.border` | `#e53935` |
| summary.text | `color.status.danger.text` | `#f73f35` |
| field.bg | `color.surface.input` | `#0c0909` |
| field.border | `color.border.control` | `#a3676b` |
| field.text | `color.text.default` | `#e99499` |
| field.label | `color.text.bright` | `#ffa2a7` |
| field.help | `color.text.muted` | `#bd787d` |
| field.affix | `color.text.muted` | `#bd787d` |
| invalid.border | `color.status.danger.border` | `#e53935` |
| invalid.message | `color.status.danger.text` | `#f73f35` |
| disabled.bg | `color.interaction.disabled.bg` | `#160b0b` |
| disabled.text | `color.text.disabled` | `#8a5559` |
| disabled.border | `color.border.disabled` | `#7d1310` |
| review.key | `color.text.muted` | `#bd787d` |
| review.header-rule | `color.border.strong` | `#9e231f` |
| review.row-rule | `color.border.divider` | `#2b0e0d` |
| footer.border | `color.border.divider` | `#2b0e0d` |
| continue.bg | `color.action.primary.bg` | `#871f19` |
| continue.text | `color.action.primary.text` | `#f4eeee` |
| continue.busy-glyph | `color.action.primary.text` | `#f4eeee` |
| back.text | `color.action.secondary.text` | `#ffa2a7` |
| back.border | `color.action.secondary.border` | `#a3676b` |
| draft.text | `color.action.tertiary.text` | `#e99499` |
| draft.bg-hover | `color.action.tertiary.hover-bg` | `#1c0a09` |
...
| root.bg | `color.surface.default` | `#160b0b` |
| root.border | `color.border.default` | `#531310` |
| toolbar.bg | `color.surface.chrome` | `#100909` |
| toolbar.border | `color.border.divider` | `#2b0e0d` |
| toolbar.separator | `color.border.default` | `#531310` |
| search.bg | `color.surface.input` | `#0c0909` |
| search.border | `color.border.control` | `#a3676b` |
| search.text | `color.text.default` | `#e99499` |
| search.placeholder | `color.text.placeholder` | `#bd787d` |
| search.icon | `color.icon.default` | `#e99499` |
| filter.text | `color.text.default` | `#e99499` |
| filter.border | `color.border.control` | `#a3676b` |
| new.bg | `color.action.primary.bg` | `#871f19` |
| new.text | `color.action.primary.text` | `#f4eeee` |
| chip.bg | `color.surface.default` | `#160b0b` |
| chip.border | `color.border.control` | `#a3676b` |
| chip.text | `color.text.default` | `#e99499` |
| chip.remove | `color.text.muted` | `#bd787d` |
| header.text | `color.text.bright` | `#ffa2a7` |
| header.rule | `color.border.strong` | `#9e231f` |
| row.text | `color.text.default` | `#e99499` |
| row.rule | `color.border.divider` | `#2b0e0d` |
| row.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
| row.ring | `color.interaction.focus.ring` | `#e53935` |
| row.selected-bg | `color.interaction.selection.bg` | `#911410` |
| row.selected-text | `color.interaction.selection.text` | `#f4eeee` |
| row.ring-on-selection | `color.interaction.focus.ring-container` | `#ffa2a7` |
| check.bg | `color.surface.input` | `#0c0909` |
| check.border | `color.border.control` | `#a3676b` |
| check.checked-bg | `color.action.primary.bg` | `#871f19` |
| check.glyph | `color.action.primary.text` | `#f4eeee` |
| badge.tested-fill | `color.status.success.fill` | `#86a46f` |
| badge.tested-text | `color.status.success.on-fill` | `#0c0909` |
| badge.demonstrated-fill | `color.status.info.fill` | `#7e9ebb` |
| badge.demonstrated-text | `color.status.info.on-fill` | `#0c0909` |
| empty.text | `color.text.muted` | `#bd787d` |
| empty.heading | `color.text.bright` | `#ffa2a7` |
| empty.glyph | `color.icon.decorative` | `#a3676b` |
| count.text | `color.text.muted` | `#bd787d` |
| pagination.text | `color.text.default` | `#e99499` |
| pagination.current | `color.text.bright` | `#ffa2a7` |
| pagination.disabled | `color.text.disabled` | `#8a5559` |
...
| Part | Role | Value |
| --- | --- | --- |
| root.bg | `color.surface.desktop` | `#000000` |
| root.border | `color.border.default` | `#531310` |
| bar.bg | `color.surface.chrome` | `#100909` |
| bar.text | `color.text.default` | `#e99499` |
| bar.rule | `color.border.divider` | `#2b0e0d` |
| workspace.text | `color.text.default` | `#e99499` |
| workspace.selected-bg | `color.interaction.selection.bg` | `#911410` |
| workspace.selected-text | `color.interaction.selection.text` | `#f4eeee` |
| workspace.bg-hover | `color.interaction.hover.bg` | `#1c0a09` |
| workspace.ring | `color.interaction.focus.ring` | `#e53935` |
| workspace.ring-on-selection | `color.interaction.focus.ring-container` | `#ffa2a7` |
| workspace.urgent-bg | `color.status.danger.fill` | `#dc282e` |
| workspace.urgent-text | `color.status.danger.on-fill` | `#f9faf9` |
| status.separator | `color.text.muted` | `#bd787d` |
| status.glyph | `color.icon.decorative` | `#a3676b` |
| clock.text | `color.text.bright` | `#ffa2a7` |
| area.bg | `color.surface.desktop` | `#000000` |
| window.bg | `color.surface.canvas` | `#0c0909` |
| window.border | `color.border.default` | `#531310` |
| window.border-focused | `color.border.active` | `#e53935` |
| window.ring | `color.interaction.focus.ring-container` | `#ffa2a7` |
| title.bg | `color.surface.chrome` | `#100909` |
| title.text | `color.text.muted` | `#bd787d` |
| title.bg-focused | `color.surface.chrome-alt` | `#1c0a09` |
| title.text-focused | `color.text.bright` | `#ffa2a7` |
| tab.indicator | `color.border.selected-indicator` | `#e53935` |
| tab.indicator-inactive | `color.border.selected-indicator-inactive` | `#9e231f` |
| floating.border | `color.border.overlay` | `#e53935` |
| floating.shadow | `shadow.floating` | `0px 6px 22px 0px rgb(0 0 0 / 55%)` |
| terminal.bg | `color.terminal.bg` | `#0c0909` |
| terminal.text | `color.terminal.fg` | `#e99499` |
| editor.bg | `color.code.bg` | `#0c0909` |
