...
<!-- generated by scripts/generate.mjs from tokens/ and spec/ — do not edit. theme: j3w1-theme 2.0.0 · profile: default · sourceDigest: sha256-5X46Ze3heKByI1jBO9ChGBqmNvqTG7rQqfZzmzuMziU= -->
...
| `color.terminal.prompt-text` | `#0c0909` | `{color.primitive.ink.20}` | Text on the prompt's path segment (slot 4): dark on the readable heritage slot 4 (D-029).; use |
...
| `color.terminal.ansi.6` | `#bb696c` | `{color.primitive.ansi-readable.6}` | ANSI slot 6, readable heritage (D-029); the heritage-ansi profile keeps the exact value.; use |
...
| `color.terminal.prompt-text` | `#0c0909` | `{color.primitive.ink.20}` | Text on the prompt's path segment (slot 4): dark on the readable heritage slot 4 (D-029).; blocked |
...
| prompt.bg | `color.terminal.ansi.4` | `#e53131` | use |
| prompt.text | `color.terminal.prompt-text` | `#0c0909` | use |
...
| slot.ansi-6 | `color.terminal.ansi.6` | `#bb696c` | use |
