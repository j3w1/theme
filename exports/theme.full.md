...
<!-- generated by scripts/generate.mjs from tokens/ and spec/ — do not edit. theme: j3w1-theme 2.0.0 · profile: default · sourceDigest: sha256-oio9XU33uxl62Ta24Gn1knvBGZOnKgBkpD7VISOr1zc= -->
...
Terminal text on the terminal surface with the readable heritage sixteen ANSI slots (D-029), the cursor, the selection and the six text attributes; a transcript, the slot grid and the attributes. Family: developer. Priority: R1. Maturity: stable. States: default, focus-visible, selected, busy, current.
