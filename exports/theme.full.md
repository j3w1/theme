...
<!-- generated by scripts/generate.mjs from tokens/ and spec/ — do not edit. theme: j3w1-theme 1.3.0 · profile: default · sourceDigest: sha256-PzV8yfSJdg94ZRMircDcypAnAT0I43VoutbC0Uo1ysg= -->
...
| `color.terminal.prompt-text` | `#0c0909` | `{color.primitive.ink.20}` | Text on the prompt's filled segments (slot 4 path, slot 3 branch): dark on the readable heritage slots (D-029).; use |
...
| `color.terminal.prompt-text` | `#0c0909` | `{color.primitive.ink.20}` | Text on the prompt's filled segments (slot 4 path, slot 3 branch): dark on the readable heritage slots (D-029).; blocked |
