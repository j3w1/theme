# j3w1 UI Theme Spec — full (3.0.0)
<!-- generated by scripts/generate.mjs from tokens/ and spec/ — do not edit. theme: j3w1-theme 3.0.0 · profile: default · sourceDigest: sha256-BBsjcvv9td0bPCjKfaTMB5lMsjpTqWhUprEfPFhAN/M= -->
...
| `color.code.syntax.keyword` | `#f7463c` | `{color.primitive.red.860}` | Keywords (Xresources color5 lineage), lifted by D-029.; use |
...
| `color.code.syntax.property` | `#e95551` | `{color.primitive.red.810}` | Properties and keys (site .syntax-key), lifted by D-029.; use |
| `color.code.syntax.heading` | `#e95551` | `{color.primitive.red.810}` | Markup headings (site .syntax-heading), lifted by D-029.; use |
| `color.code.syntax.tag` | `#f7463c` | `{color.primitive.red.860}` | Markup tags, lifted by D-029.; use |
...
| `color.code.syntax.invalid` | `#e95551` | `{color.primitive.red.810}` | Invalid text: wavy underline; lifted by D-029.; use |
| `color.code.syntax.deprecated` | `#ad7175` | `{color.primitive.rose.450}` | Deprecated symbol: line-through.; use |
| `color.code.hued.string` | `#86a46f` | `{color.primitive.green.500}` | Strings in green (D-030).; use |
| `color.code.hued.number` | `#c9973f` | `{color.primitive.amber.500}` | Numbers in amber (D-030).; use |
| `color.code.hued.constant` | `#c9973f` | `{color.primitive.amber.500}` | Constants in amber (D-030).; use |
| `color.code.hued.function` | `#c9973f` | `{color.primitive.amber.500}` | Function and method names in amber (D-030).; use |
| `color.code.hued.attribute` | `#c9973f` | `{color.primitive.amber.500}` | Markup attribute names in amber (D-030).; use |
| `color.code.hued.escape` | `#c9973f` | `{color.primitive.amber.500}` | Escapes in amber (D-030).; use |
| `color.code.hued.type` | `#7e9ebb` | `{color.primitive.blue.500}` | Types in blue (D-030).; use |
| `color.code.hued.property` | `#7e9ebb` | `{color.primitive.blue.500}` | Object properties in blue (D-030).; use |
| `color.code.hued.operator` | `#ffa2a7` | `{color.primitive.rose.800}` | Operators in bright rose (D-030).; use |
...
| `color.terminal.prompt-bg` | `#8c1212` | `{color.primitive.ansi.4}` | Background of the prompt's path segment: the heritage dark red, so the prompt keeps its look whatever slot 4 carries (D-032).; use |
| `color.terminal.prompt-text` | `#ffa2a7` | `{color.primitive.rose.800}` | Text on the prompt's path segment: bright rose on the prompt background (D-032).; use |
| `color.terminal.ansi.0` | `#0c0909` | `{color.primitive.ansi.0}` | ANSI slot 0, exact heritage value.; use |
| `color.terminal.ansi.1` | `#e84b4b` | `{color.primitive.ansi-readable.1}` | ANSI slot 1, readable heritage (D-029); the heritage-ansi profile keeps the exact value.; use |
...
| `color.terminal.ansi.4` | `#e53131` | `{color.primitive.ansi-readable.4}` | ANSI slot 4, readable heritage (D-029); the heritage-ansi profile keeps the exact value.; use |
| `color.terminal.ansi.5` | `#f73f35` | `{color.primitive.ansi.5}` | ANSI slot 5, exact heritage value.; use |
| `color.terminal.ansi.6` | `#ff7a66` | `{color.primitive.coral.700}` | ANSI slot 6, coral (D-032); the heritage-ansi profile keeps the exact value.; use |
| `color.terminal.ansi.7` | `#ffa2a7` | `{color.primitive.ansi.7}` | ANSI slot 7, exact heritage value.; use |
| `color.terminal.ansi.8` | `#b71c17` | `{color.primitive.ansi-readable.8}` | ANSI slot 8, readable heritage (D-029); the heritage-ansi profile keeps the exact value.; use |
| `color.terminal.ansi.9` | `#ea3833` | `{color.primitive.ansi-readable.9}` | ANSI slot 9, readable heritage (D-029); the heritage-ansi profile keeps the exact value.; use |
| `color.terminal.ansi.10` | `#dc4f49` | `{color.primitive.ansi-readable.10}` | ANSI slot 10, readable heritage (D-029); the heritage-ansi profile keeps the exact value.; use |
| `color.terminal.ansi.11` | `#b37175` | `{color.primitive.ansi.11}` | ANSI slot 11, exact heritage value.; use |
| `color.terminal.ansi.12` | `#db433a` | `{color.primitive.ansi-readable.12}` | ANSI slot 12, readable heritage (D-029); the heritage-ansi profile keeps the exact value.; use |
| `color.terminal.ansi.13` | `#ed5360` | `{color.primitive.ansi-readable.13}` | ANSI slot 13, readable heritage (D-029); the heritage-ansi profile keeps the exact value.; use |
| `color.terminal.ansi.14` | `#e6565a` | `{color.primitive.ansi-readable.14}` | ANSI slot 14, readable heritage (D-029); the heritage-ansi profile keeps the exact value.; use |
| `color.terminal.ansi.15` | `#b17e81` | `{color.primitive.ansi-readable.15}` | ANSI slot 15, readable heritage (D-029); the heritage-ansi profile keeps the exact value.; use |
...
| `color.code.syntax.keyword` | `#f73f35` | `{color.primitive.red.850}` | Keywords, historical value before D-029.; historical-only |
...
| `color.code.syntax.property` | `#e53935` | `{color.primitive.red.800}` | Properties and keys, historical value before D-029.; historical-only |
| `color.code.syntax.heading` | `#e53935` | `{color.primitive.red.800}` | Markup headings, historical value before D-029.; historical-only |
| `color.code.syntax.tag` | `#f73f35` | `{color.primitive.red.850}` | Markup tags, historical value before D-029.; historical-only |
...
| `color.code.syntax.invalid` | `#e53935` | `{color.primitive.red.800}` | Invalid text, historical value before D-029.; historical-only |
| `color.code.syntax.deprecated` | `#ad7175` | `{color.primitive.rose.450}` | Deprecated symbol: line-through.; historical-only |
| `color.code.hued.string` | `#86a46f` | `{color.primitive.green.500}` | Strings in green (D-030).; historical-only |
| `color.code.hued.number` | `#c9973f` | `{color.primitive.amber.500}` | Numbers in amber (D-030).; historical-only |
| `color.code.hued.constant` | `#c9973f` | `{color.primitive.amber.500}` | Constants in amber (D-030).; historical-only |
| `color.code.hued.function` | `#c9973f` | `{color.primitive.amber.500}` | Function and method names in amber (D-030).; historical-only |
| `color.code.hued.attribute` | `#c9973f` | `{color.primitive.amber.500}` | Markup attribute names in amber (D-030).; historical-only |
| `color.code.hued.escape` | `#c9973f` | `{color.primitive.amber.500}` | Escapes in amber (D-030).; historical-only |
| `color.code.hued.type` | `#7e9ebb` | `{color.primitive.blue.500}` | Types in blue (D-030).; historical-only |
| `color.code.hued.property` | `#7e9ebb` | `{color.primitive.blue.500}` | Object properties in blue (D-030).; historical-only |
| `color.code.hued.operator` | `#ffa2a7` | `{color.primitive.rose.800}` | Operators in bright rose (D-030).; historical-only |
...
| `color.terminal.prompt-bg` | `#8c1212` | `{color.primitive.ansi.4}` | The heritage slot 4 behind the prompt's path segment, as the workstation drew it.; historical-only |
| `color.terminal.prompt-text` | `#f4eeee` | `{color.primitive.paper.90}` | Light prompt text on the heritage slot 4, as the workstation drew it.; historical-only |
| `color.terminal.ansi.0` | `#0c0909` | `{color.primitive.ansi.0}` | ANSI slot 0, exact heritage value.; historical-only |
| `color.terminal.ansi.1` | `#c81a1a` | `{color.primitive.ansi.1}` | ANSI slot 1, exact heritage value (#c81a1a).; historical-only |
...
| `color.terminal.ansi.4` | `#8c1212` | `{color.primitive.ansi.4}` | ANSI slot 4, exact heritage value (#8c1212).; historical-only |
| `color.terminal.ansi.5` | `#f73f35` | `{color.primitive.ansi.5}` | ANSI slot 5, exact heritage value.; historical-only |
| `color.terminal.ansi.6` | `#9e474a` | `{color.primitive.ansi.6}` | ANSI slot 6, exact heritage value (#9e474a).; historical-only |
| `color.terminal.ansi.7` | `#ffa2a7` | `{color.primitive.ansi.7}` | ANSI slot 7, exact heritage value.; historical-only |
| `color.terminal.ansi.8` | `#7d1310` | `{color.primitive.ansi.8}` | ANSI slot 8, exact heritage value (#7d1310).; historical-only |
| `color.terminal.ansi.9` | `#ab1612` | `{color.primitive.ansi.9}` | ANSI slot 9, exact heritage value (#ab1612).; historical-only |
| `color.terminal.ansi.10` | `#ad2721` | `{color.primitive.ansi.10}` | ANSI slot 10, exact heritage value (#ad2721).; historical-only |
| `color.terminal.ansi.11` | `#b37175` | `{color.primitive.ansi.11}` | ANSI slot 11, exact heritage value.; historical-only |
| `color.terminal.ansi.12` | `#871f19` | `{color.primitive.ansi.12}` | ANSI slot 12, exact heritage value (#871f19).; historical-only |
| `color.terminal.ansi.13` | `#e82132` | `{color.primitive.ansi.13}` | ANSI slot 13, exact heritage value (#e82132).; historical-only |
| `color.terminal.ansi.14` | `#e0292f` | `{color.primitive.ansi.14}` | ANSI slot 14, exact heritage value (#e0292f).; historical-only |
| `color.terminal.ansi.15` | `#a3676b` | `{color.primitive.ansi.15}` | ANSI slot 15, exact heritage value (#a3676b).; historical-only |
...
| `color.code.syntax.keyword` | `#f7463c` | `{color.primitive.red.860}` | Keywords (Xresources color5 lineage), lifted by D-029.; blocked |
...
| `color.code.syntax.heading` | `#e95551` | `{color.primitive.red.810}` | Markup headings (site .syntax-heading), lifted by D-029.; blocked |
| `color.code.syntax.tag` | `#f7463c` | `{color.primitive.red.860}` | Markup tags, lifted by D-029.; blocked |
| `color.code.syntax.invalid` | `#e95551` | `{color.primitive.red.810}` | Invalid text: wavy underline; lifted by D-029.; blocked |
| `color.code.syntax.deprecated` | `#ad7175` | `{color.primitive.rose.450}` | Deprecated symbol: line-through.; blocked |
| `color.code.hued.string` | `#86a46f` | `{color.primitive.green.500}` | Strings in green (D-030).; blocked |
| `color.code.hued.number` | `#c9973f` | `{color.primitive.amber.500}` | Numbers in amber (D-030).; blocked |
| `color.code.hued.constant` | `#c9973f` | `{color.primitive.amber.500}` | Constants in amber (D-030).; blocked |
| `color.code.hued.function` | `#c9973f` | `{color.primitive.amber.500}` | Function and method names in amber (D-030).; blocked |
| `color.code.hued.attribute` | `#c9973f` | `{color.primitive.amber.500}` | Markup attribute names in amber (D-030).; blocked |
| `color.code.hued.escape` | `#c9973f` | `{color.primitive.amber.500}` | Escapes in amber (D-030).; blocked |
| `color.code.hued.type` | `#7e9ebb` | `{color.primitive.blue.500}` | Types in blue (D-030).; blocked |
| `color.code.hued.property` | `#7e9ebb` | `{color.primitive.blue.500}` | Object properties in blue (D-030).; blocked |
| `color.code.hued.operator` | `#ffa2a7` | `{color.primitive.rose.800}` | Operators in bright rose (D-030).; blocked |
...
| `color.terminal.prompt-bg` | `#8c1212` | `{color.primitive.ansi.4}` | Background of the prompt's path segment: the heritage dark red, so the prompt keeps its look whatever slot 4 carries (D-032).; blocked |
| `color.terminal.prompt-text` | `#ffa2a7` | `{color.primitive.rose.800}` | Text on the prompt's path segment: bright rose on the prompt background (D-032).; blocked |
...
| syntax.keyword | `color.code.syntax.keyword` | `#f7463c` | use |
...
| syntax.property | `color.code.syntax.property` | `#e95551` | use |
| syntax.heading | `color.code.syntax.heading` | `#e95551` | use |
| syntax.tag | `color.code.syntax.tag` | `#f7463c` | use |
| syntax.attribute | `color.code.syntax.attribute` | `#d4868b` | use |
| syntax.escape | `color.code.syntax.escape` | `#d4868b` | use |
| syntax.invalid | `color.code.syntax.invalid` | `#e95551` | use |
...
Terminal text with the readable heritage sixteen ANSI slots (D-029, D-032), the cursor, the selection and the six text attributes; a transcript, the slot grid and the attributes. Family: developer. Priority: R1. Maturity: stable. States: default, focus-visible, selected, busy, current.
...
| prompt.bg | `color.terminal.prompt-bg` | `#8c1212` | use |
| prompt.text | `color.terminal.prompt-text` | `#ffa2a7` | use |
...
| slot.ansi-1 | `color.terminal.ansi.1` | `#e84b4b` | use |
| slot.ansi-2 | `color.terminal.ansi.2` | `#bd787d` | use |
| slot.ansi-3 | `color.terminal.ansi.3` | `#d4868b` | use |
| slot.ansi-4 | `color.terminal.ansi.4` | `#e53131` | use |
| slot.ansi-5 | `color.terminal.ansi.5` | `#f73f35` | use |
| slot.ansi-6 | `color.terminal.ansi.6` | `#ff7a66` | use |
| slot.ansi-7 | `color.terminal.ansi.7` | `#ffa2a7` | use |
| slot.ansi-8 | `color.terminal.ansi.8` | `#b71c17` | use |
| slot.ansi-9 | `color.terminal.ansi.9` | `#ea3833` | use |
| slot.ansi-10 | `color.terminal.ansi.10` | `#dc4f49` | use |
| slot.ansi-11 | `color.terminal.ansi.11` | `#b37175` | use |
| slot.ansi-12 | `color.terminal.ansi.12` | `#db433a` | use |
| slot.ansi-13 | `color.terminal.ansi.13` | `#ed5360` | use |
| slot.ansi-14 | `color.terminal.ansi.14` | `#e6565a` | use |
| slot.ansi-15 | `color.terminal.ansi.15` | `#b17e81` | use |
