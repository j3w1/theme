/* Pure generators: a loaded context in, file contents out. No clock, no
   filesystem; the caller passes resolvedAt for the lock. */
...
export const codexThemeObject = (ctx) => {
  ...
  return {
    name: map.theme.name,
    comment: `j3w1-theme ${ctx.theme.version} (${ctx.theme.ref} ${ctx.theme.revision}) profile ${ctx.theme.profile}; generated by ${ctx.kit.id}, do not edit.`,
