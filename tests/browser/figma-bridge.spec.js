...
const { annotation } = verification({ component: "page", category: "enhancements", states: [], variants: [], note: "Static bridge instructions, downloadable real adapter, explicit API/account limits and observed sample status. This browser protocol does not itself import to Figma; real import receipts are separate." });
