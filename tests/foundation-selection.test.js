...
test("D-023 reproduces the selected surfaces and preserves historical surface assignments", async () => {
  ...
  for (const [role, expected] of Object.entries({ "text.default": "#e99499", "text.bright": "#ffa2a7", "text.prose": "#f4eeee", "interaction.selection.bg": "#911410", "interaction.focus.ring": "#e53935", "surface.raised": "#241010" })) {
