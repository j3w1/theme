...
Complete copy distribution from @j3w1/ui 3.0.0.
...
runtime/register/segmented-control.js once. Keep the complete runtime directory.
...
Canonical contract: https://github.com/j3w1/theme/blob/v3.0.0/spec/components/segmented-control.md

Package alternative: import '@j3w1/ui/register/segmented-control';
Load '@j3w1/ui/tokens.css' and '@j3w1/ui/styles/segmented-control.css'.
