...
runtime/register/loading-indicator.js once. Keep the complete runtime directory.
...
Canonical contract: https://github.com/j3w1/theme/blob/v3.0.0/spec/components/loading-indicator.md

Package alternative: import '@j3w1/ui/register/loading-indicator';
Load '@j3w1/ui/tokens.css' and '@j3w1/ui/styles/loading-indicator.css'.
