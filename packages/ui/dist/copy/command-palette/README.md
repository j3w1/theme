...
runtime/register/command-palette.js once. Keep the complete runtime directory.
...
Canonical contract: https://github.com/j3w1/theme/blob/v1.2.0/spec/components/command-palette.md

Package alternative: import '@j3w1/ui/register/command-palette';
Load '@j3w1/ui/tokens.css' and '@j3w1/ui/styles/command-palette.css'.
