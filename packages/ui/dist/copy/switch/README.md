...
runtime/register/switch.js once. Keep the complete runtime directory.
...
Canonical contract: https://github.com/j3w1/theme/blob/v1.2.0/spec/components/switch.md

Package alternative: import '@j3w1/ui/register/switch';
Load '@j3w1/ui/tokens.css' and '@j3w1/ui/styles/switch.css'.
