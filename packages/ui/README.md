...
```sh
npm install --save-exact @j3w1/ui@1.3.0
```
...
```sh
npm install --save-exact ./j3w1-ui-1.3.0.tgz
```
...
```sh
npx --package=@j3w1/ui@1.3.0 j3w1-ui copy dialog --out ./vendor/j3w1/dialog
npx --package=@j3w1/ui@1.3.0 j3w1-ui kit --components text-field,button,dialog --out ./vendor/j3w1/task
```
