...
<template><header class="view-heading"><div><p class="eyebrow">J3W1 / COMPONENT GALLERY</p><h1 tabindex="-1">{{ item?.name ?? `${index.components.length} components. One foundation.` }}</h1><p>Official package implementations, rendered inside a Vue application.</p></div><RouterLink v-if="item" to="/components">← All components</RouterLink></header>
