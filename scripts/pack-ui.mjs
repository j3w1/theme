...
const result = packedPackage(execFileSync(process.execPath, [process.env.npm_execpath, "pack", "--workspace", "@j3w1/ui", "--pack-destination", directory, "--json"], { cwd: repoRoot, encoding: "utf8" }), "@j3w1/ui");
